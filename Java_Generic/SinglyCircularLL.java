...
public class SinglyCircularLL
{
    public static void main (String A[])
    {
        ...
        if(datatype == 1)
        {
            SinglyCLL<Integer> list = new SinglyCLL<Integer>();
            int iValue = 0;

            while(ichoice != 0)
            {
                System.out.println("-------------------------------------------------------------------------------");
                System.out.println("----------------------------- Singly Circular Linked List In Generic -----------------------");
                System.out.println("-------------------------------------------------------------------------------");
                ...
                switch(ichoice)
                {
                    ...
                    case 0: 
                        System.out.println("Thank you for using the Singly Circular Linked List In Generic application...!");
                        sobj.close();
                        return;
        ...
        {
             SinglyCLL<Double> list = new SinglyCLL<Double>();
             double iValue = 0.0;
        ...
        {
             SinglyCLL<Character> list = new SinglyCLL<Character>();
             char iValue;
